...
@Component({
  ...
  styleUrls: ['./empresa-listar.component.sass']
})
export class EmpresaListarComponent implements OnInit {

  @Output() sendEmpresa = new EventEmitter();

  displayedColumns: string[] = ['no', 'name', 'ruc', 'email', 'website', 'address', 'phone', 'action'];

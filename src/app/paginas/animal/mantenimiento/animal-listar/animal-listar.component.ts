...
export class AnimalListarComponent implements OnInit {
  ...
  displayedColumns: string[] = ['no', 'arete', 'raza','categoriareproduccion','categoriaproduccion','sexo', 'estadoproductivo', 'estadoreproductivo', 'corral', 'fechadenacimiento', 'fechadeultimoparto','numeropartos','madre','padre','precio','prueba','venta','action'];

...
@Component({
  ...
  styleUrls: ['./inventario-listar.component.sass']
})
export class InventarioListarComponent implements OnInit {

  @Output() sendInventario = new EventEmitter();

  displayedColumns: string[] = ['no', 'nombrenum','nombre', 'nombreRaza','numPajuelasDisponibles','nombreGrupo', 'action'];
